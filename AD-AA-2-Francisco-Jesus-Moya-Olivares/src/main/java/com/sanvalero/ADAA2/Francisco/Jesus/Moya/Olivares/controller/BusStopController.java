...
import com.sanvalero.ADAA2.Francisco.Jesus.Moya.Olivares.exception.BusStopNotFopundException;
import com.sanvalero.ADAA2.Francisco.Jesus.Moya.Olivares.repository.BusStopRepository;
import com.sanvalero.ADAA2.Francisco.Jesus.Moya.Olivares.service.BusStopService;
...
public class BusStopController {
    ...
    public ResponseEntity<BusStop> getBusStop(@PathVariable Integer id) {
        BusStop busstop = busstopservice.findById(id)
                .orElseThrow(() -> new BusStopNotFopundException(id));
    ...
    @ExceptionHandler(BusStopNotFopundException.class)
    @ResponseBody
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<Response> handleException(BusStopNotFopundException bsnfe) {
